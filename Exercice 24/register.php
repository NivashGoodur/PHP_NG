...
//Unclusion de la fonction permettant de vérifier le si le captcha est valide ou pas
...
<body>
    ...
    if(isset($success)){
        ...
        <form action="register.php" method="POST">
            ...
            <div class="g-recaptcha" data-sitekey="6LeFihAaAAAAAPUSWYR044odRcREZqbgxf5e-83J"></div>
            <input type="submit">
        </form>
